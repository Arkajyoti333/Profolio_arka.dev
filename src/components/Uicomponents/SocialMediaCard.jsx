...
const Tooltip = ({socialLinks}) => {
  return (
    <StyledWrapper>
      <ul className="example-2">
        <li className="icon-content">
          <a href={socialLinks[0]?.href} target='_blank' aria-label="LinkedIn" data-social="linkedin">
          ...
          <div className="tooltip">{socialLinks[0]?.text}</div>
        </li>
        <li className="icon-content">
          <a href={socialLinks[1]?.href} target='_blank' aria-label="GitHub" data-social="github">
            <div className="filled" />
          ...
          <div className="tooltip">{socialLinks[1]?.text}</div>
        </li>
        <li className="icon-content">
          <a href={socialLinks[2]?.href} target='_blank'aria-label="Instagram" data-social="instagram">
            <div className="filled" />
          ...
          <div className="tooltip">{socialLinks[2]?.text}</div>
        </li>
        <li className="icon-content">
  {socialLinks[3] ? (
    <a
    ...
    >
      ...
      <svg
        ...
        fill="currentColor"
      >
        <path d="M279.14 288l14.22-92.66h-88.91V132.41c0-25.35 12.42-50.06 52.24-50.06H293V6.26S270.91 0 239.78 0c-73.36 0-121.14 44.47-121.14 124.72V195.3H48v92.66h70.64V512h100.2V288z" />
      </svg>
    </a>
  ) : (
    <span className="tooltip">Link not available</span>
  )}
  <div className="tooltip">{socialLinks[3]?.text || "Facebook"}</div>
</li>
